...
INSERT INTO `exports` VALUES (1,'حسین سلطانیان','9283422','09125174854',1,'کرج -کرج=-ایران -سیسی',10000000,10,'','1404/02/10 سه‌شنبه 04:59:09 ب.ظ',0,2);
...
INSERT INTO `products` VALUES (1,' ایزوگام شرق صادراتی',99250,0,0,0,0,100,0,0,100,0,2,'roll'),(2,'ایزوگام غرب شرق مخصوص',92500,0,0,0,0,80,0,0,0,0,2,'roll'),(3,'ایزوگام شمال شرق بدون فویل',110000,0,0,0,0,115000,0,0,0,0,2,'roll'),(4,'ایزوگام سپید گام صادراتی',95000,0,0,0,0,120,0,0,0,0,2,'roll'),(5,'ایزوگام سپیدگام صادراتی بدون فویل',87500,0,0,0,0,80,0,0,0,0,2,'roll'),(6,'ایزوگام اصلاحی درجه ۲',0,108000,0,0,0,0,53,0,0,0,2,'meter'),(7,'ایزوگام شرق طرح دار',95000,0,0,0,0,120,0,0,0,0,2,'roll'),(8,'بشکه قیر',0,0,0,0,108000,0,0,0,0,71,2,'barrel'),(10,'یه بشکه',0,0,0,0,250000,0,0,0,0,0,1,'');
...
INSERT INTO `users` VALUES (1,'hossein Soltanian','hosseinbidar7@gmail.com','$2a$14$r0evCl.KCZUnXh3cw2x/be0D0E1/AoclpUVPUSSFB0Re2BAH/6C7.','09125174854','','Admin');
...
-- Dump completed on 2025-04-29 17:45:26
