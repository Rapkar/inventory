...
INSERT INTO `exports` VALUES (1,'حسین سلطانیان','9283422','09125174854',1,'کرج -کرج=-ایران -سیسی',10000000,10,'','1404/02/10 سه‌شنبه 04:59:09 ب.ظ',1,2),(2,'ali','A04242','02534161616',2,'سیبی سیبسی',1200,1200,'لاتلا','1404/02/11 چهارشنبه 12:06:48 ب.ظ',1,1),(3,'حسینم','Z07435','02134249381',3,'sdsd',5395751,0,'','1404/02/12 پنج‌شنبه 02:22:41 ق.ظ',0,1);
...
INSERT INTO `payments` VALUES (1,'نقدی','PMT-367380','نقدی',1200,'','۱۴۰۴/۰۲/۱۱',2,2,1,'collected'),(2,'نقدی','PMT-304684','نقدی',251000,'','۱۴۰۴/۰۲/۱۲',3,3,1,'collected');
...
INSERT INTO `products` VALUES (1,' ایزوگام شرق صادراتی',99251,0,0,0,0,140,3,0,111,3,1,'roll'),(2,'ایزوگام غرب شرق مخصوص',92510,0,0,0,0,80,0,0,2,0,1,'roll'),(3,'ایزوگام شمال شرق بدون فویل',110000,0,0,0,0,115000,0,0,0,0,2,'roll'),(4,'ایزوگام سپید گام صادراتی',95000,0,0,0,1000,120,0,0,10,3,1,'roll'),(5,'ایزوگام سپیدگام صادراتی بدون فویل',87500,0,0,0,0,80,0,0,19,0,1,'roll'),(6,'ایزوگام اصلاحی درجه ۲',0,108100,0,0,0,0,15,0,0,0,1,'meter'),(7,'ایزوگام شرق طرح دار',95000,0,0,0,0,120,0,0,0,0,2,'roll'),(8,'بشکه قیر',0,0,0,0,108000,0,0,0,0,77,1,'barrel'),(11,'یه بشکه',0,0,0,0,25100,0,0,0,0,160,1,'barrel');
...
INSERT INTO `users` VALUES (1,'hossein Soltanian','hosseinbidar7@gmail.com','$2a$14$r0evCl.KCZUnXh3cw2x/be0D0E1/AoclpUVPUSSFB0Re2BAH/6C7.','09125174854','','Admin'),(2,'ali','','','02534161616','سیبی سیبسی','guest'),(3,'حسینم','','','02134249381','sdsd','guest');
...
-- Dump completed on 2025-05-01  9:49:08
